...
@pytest.mark.parametrize("except_user1", ["user2", "user3", "user4"])
...
@pytest.mark.parametrize("except_user2", ["user1", "user3", "user4"])
...
@pytest.mark.parametrize("except_user3", ["user1", "user2", "user4"])
...
@pytest.mark.parametrize("except_user4", ["user1", "user2", "user3"])
